          ...
          <div class="checkout__totals-wrapper">
            <div class="sticky-content">
              ...
              <div class="checkout__payment-methods">
                ...
                <div class="form-check">
                  <input class="form-check-input form-check-input_fill" type="radio" name="mode" id="checkout_payment_method_3" value="cod" checked>
                ...
                <div class="policy-text">
                  ...
                  website, and for other purposes described in our <a href="" >privacy
                    policy</a>.
                </div>
              </div>
