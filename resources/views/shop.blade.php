        ...
        <div class="accordion" id="brand-filters">
            <div class="accordion-item mb-3">
              <h5 class="accordion-header" id="accordion-heading-brand">
                <button class="accordion-button p-2 border-0 fs-5 fw-bold" type="button"
              ...
              <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
                ...
                <div class="accordion-body px-2 py-1">
                  <ul class="list-unstyled brand-list mb-0">
                    @foreach ($brands as $brand)
                    <li class="py-2 d-flex justify-content-between border-bottom">
                      <label class="d-flex align-items-center">
                        <input type="checkbox" name="brands" class="me-2" value="{{ $brand->id }}"
                          @if(in_array($brand->id, explode(',', $filter_brands))) checked="checked" @endif>
                        {{ $brand->name }}
                      </label>
                      <span class="text-muted">{{ $brand->product->count() }}</span>
                    </li>
                    @endforeach
                  </ul>
                </div>
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="products-grid row row-cols-2 row-cols-md-3" id="products-grid">
          ...
          <div class="product-card-wrapper">
            <div class="product-card product-box mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                ...
                @if(Cart::instance('wishlist')->content()->where('id', $product->id)->count() > 0)
                    @php
                        // Get the rowId from wishlist for this product
