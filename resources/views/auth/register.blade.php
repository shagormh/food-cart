...
@section('content')
<main class="register-page" style="padding-top: 140px;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="card shadow border-0 rounded-3">
                    <div class="card-header bg-primary text-white p-4 text-center">
                        ...
                        <p class="mb-0 mt-2 small">Join us and enjoy exclusive benefits</p>
                    </div>
                        ...
                        <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3 form-check">
                                ...
                                <label class="form-check-label small" for="privacyPolicy">
                                    I agree that my personal data will be used to support my experience throughout this website,
                                    to manage access to my account, and for other purposes described in our privacy policy.
                                </label>
                            </div>
...
<style>
    .register-page {
        ...
        min-height: 100vh;
        padding-top: 140px; /* <-- Adjusted to avoid header overlap */
        display: flex;
        align-items: center;
    }
