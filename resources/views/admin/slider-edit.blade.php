    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <div class="text-tiny">Slide Udpate</div>
                </li>
            </ul>
        </div>
        <!-- new-category -->
            ...
            <form class="form-new-product form-style-1" action="{{ route('admin.slider.update',$slider->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Tagline" name="tagline"
                        tabindex="0" value="{{ $slider->tagline }}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Title" name="title"
                        tabindex="0" value="{{ $slider->title }}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Subtitle" name="subtitle"
                        tabindex="0" value="{{ $slider->subtitle }}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Link" name="link"
                        tabindex="0" value="{{ $slider->link }}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        <div class="item" id="imgpreview">
                            <img src="{{ asset('uploads/sliders') }}/{{ $slider->image }}" class="effect8" alt="{{ $slider->title }}">
                        </div>
