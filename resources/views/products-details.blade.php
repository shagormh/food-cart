                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach (explode(',', $product->images) as $images)
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto"
                                                src="{{ asset('uploads/products') }}/{{ $images }}" width="674" height="674"
                                                alt="" />
                                            <a data-fancybox="gallery" href=".{{ asset('uploads/products') }}/{{ $images }}"
                                                data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <use href="#icon_zoom" />
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach (explode(',', $product->image) as $images)
                                        <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                                src="{{ asset('uploads/products/thumbnails') }}/{{ $images }}" width="104"
                                                height="104" alt="" />
                                        </div>
                                    @endforeach
                                </div>
                ...
                <div class="col-lg-5">
                    <div class="d-flex justify-content-between mb-4 pb-md-2">
                        <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
                            ...
                            <a href="{{ route('home.shop') }}" class="menu-link menu-link_us-s text-uppercase fw-medium">The
                                Shop</a>
                        </div><!-- /.breadcrumb -->
                    ...
                    <div class="product-single__addtolinks">
                        @if(Cart::instance('wishlist')->content()->where('id', $product->id)->count() > 0)
                                            @php
                                                // Get the actual rowId from the wishlist for this product
                                                $wishlistItem = Cart::instance('wishlist')->content()->where('id', $product->id)->first();
                                                $rowId = $wishlistItem ? $wishlistItem->rowId : null;
                                            @endphp
                                            ...
                                            <form action="{{ route('wishlist.item.remove', ['rowId' => $rowId]) }}" method="post">
                                                ...
                                                <a href="javascript:void(0)" onclick="this.closest('form').submit()"
                                                    class="filled-heart menu-link menu-link_us-s add-to-wishlist">
                        ...
                        @endif
                        {{-- @if(Cart::instance('wishlist')->content()->where('id',$product->id)->count()>0)
                        <form action="{{ route('wishlist.item.remove', ['rowId' => $product->id]) }}" method="post">
                            @csrf
                            @method('DELETE')
                            <a href="javascript:void(0)" onclick="this.closest('form').submit()"
                                class="filled-heart menu-link menu-link_us-s add-to-wishlist">
            ...
            <div class="product-single__details-tab">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-reviews" role="tabpanel" aria-labelledby="tab-reviews-tab">
                        ...
                        <div class="product-single__reviews-list">
                            <!-- Review 1 - Fresh Produce -->
                            <div class="product-single__reviews-item">
                                <div class="customer-avatar">
                                    <img loading="lazy" src="https://randomuser.me/api/portraits/women/65.jpg" alt="Fatima Begum" />
                                </div>
                                <div class="customer-review">
                                    <div class="customer-name">
                                        <h6>Fatima Begum</h6>
                                    ...
                                    <div class="review-text">
                                        <p>আমি গত সপ্তাহে এই কাচা বাজার থেকে শাকসবজি কিনেছি, সবকিছু খুব তাজা ছিল! বিশেষ করে পালং শাক এবং লাল শাকের গুণগত মান অসাধারণ ছিল। ডেলিভারিও সময়মতো পেয়েছি। নিশ্চয়ই আবার অর্ডার দিব!</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="product-single__reviews-item">
                                <div class="customer-avatar">
                                    <img loading="lazy" src="https://randomuser.me/api/portraits/men/75.jpg" alt="Abdul Karim" />
                                </div>
                                <div class="customer-review">
                                    <div class="customer-name">
                                        <h6>Abdul Karim</h6>
                                    ...
                                    <div class="review-date">February 5, 2025</div>
                                    <div class="review-text">
                                        <p>ইলিশ মাছটা একদম সতেজ ছিল! বাজারে যে মানের ইলিশ পাওয়া যায়, তার চেয়ে ভালো কোয়ালিটি পেয়েছি। প্যাকেজিংও খুব ভালো ছিল, বরফ দিয়ে ঠিকঠাক পাঠানো হয়েছে। পরিবারের সবাই খুব উপভোগ করেছে।</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="product-single__reviews-item">
                                <div class="customer-avatar">
                                    <img loading="lazy" src="https://randomuser.me/api/portraits/women/33.jpg" alt="Nusrat Jahan" />
                                </div>
                                <div class="customer-review">
                                    <div class="customer-name">
                                        <h6>Nusrat Jahan</h6>
                                    ...
                                    <div class="review-date">March 20, 2025</div>
                                    <div class="review-text">
                                        <p>চাল, ডাল এবং মসলা প্যাকেজ অর্ডার করেছিলাম। সবকিছুর কোয়ালিটি দেখে খুব খুশি হয়েছি। বিশেষ করে চালের মান খুব ভালো ছিল, ভাত হয়েছিল একদম ঝরঝরে। মসলাগুলোও খুব সুগন্ধযুক্ত। দামও বাজারের চেয়ে কম!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="product-single__review-form">
                            <form name="customer-review-form">
                                <h5>Be the first to review "Fresh Grocery Package"</h5>
                                <p>Your email address will not be published. Required fields are marked *</p>
                                <div class="select-star-rating">
                                    <label>Your rating *</label>
                                    <span class="star-rating">
                                ...
                                <div class="mb-4">
                                    <textarea id="form-input-review" class="form-control form-control_gray" placeholder="আপনার রিভিউ লিখুন..." cols="30" rows="8"></textarea>
                                </div>
                                <div class="form-label-fixed mb-4">
                                    <label for="form-input-name" class="form-label">নাম *</label>
                                    <input id="form-input-name" class="form-control form-control-md form-control_gray">
                                </div>
                                <div class="form-label-fixed mb-4">
                                    <label for="form-input-email" class="form-label">ইমেইল *</label>
                                    <input id="form-input-email" class="form-control form-control-md form-control_gray">
                                </div>
                                <div class="form-check mb-4">
                                    <input class="form-check-input form-check-input_fill" type="checkbox" value="" id="remember_checkbox">
                                    <label class="form-check-label" for="remember_checkbox">
                                        পরবর্তী সময়ে কমেন্ট করার জন্য আমার নাম, ইমেইল এবং ওয়েবসাইট সংরক্ষণ করুন
                                    </label>
                                </div>
                                <div class="form-action">
                        ...
                        <div class="swiper-slide product-card">
                            <div class="pc__img-wrapper">
                                <a href="{{ route('home.shop.details',$rproduct->slug) }}">
                                    ...
                                    <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $gimages }}" width="330"
                            ...
                            <div class="pc__info position-relative">
                                ...
                                <h6 class="pc__title"><a href="{{ route('home.shop.details',$rproduct->slug) }}">{{
                                        $rproduct->name }}</a></h6>
